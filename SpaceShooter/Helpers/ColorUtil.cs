/*
 * Author: Shon Vivier
 * File Name: ColorUtil.cs
 * Project Name: SpaceShooter
 * Creation Date: 5/20/2019
 * Modified Date: 5/20/2019
 * Description: A utility class that handles converting Color to HSV and back
*/
...
namespace ShapeBlaster
{
    ...
    {
        /// <summary>
        /// Converts a color to a hue-saturation-value
        /// </summary>
        ...
        /// <summary>
        /// An overload method that simplifies the parameters for conversion
        /// </summary>
        ...
        /// <summary>
        /// Converts a hue-saturation-value to a color to
        /// </summary>
